...
public class Swing extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        searchByName.setText("Tìm kiếm theo tên");
        ...
        searchByPrice.setText("Tìm kiếm theo giá");
        ...
        searchByTime.setText("Tìm kiếm theo thời gian");
        ...
        sortByPrice.setText("Sắp xếp theo giá");
        ...
        hienthi.setText("Hiển thị danh sách");
